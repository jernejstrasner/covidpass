    ...
    <div className="flex flex-col justify-center items-center h-screen font-sans">
      ...
      <main className="md:bg-gray-50 font-bold md:rounded-lg md:border md:shadow-lg p-5 md:p-10 text-center">
        <h1 className="text-2xl text-blue-500 font-medium md:text-4xl">
          <a href="https://ec.europa.eu/info/live-work-travel-eu/coronavirus-response/safe-covid-19-vaccines-europeans/eu-digital-covid-certificate_en" target="_blank" rel="noreferrer">EU Digital COVID Certificate</a>
        </h1>

        <p className="font-normal mt-5 text-sm md:text-md">
          Add your EU Digital COVID Certificate to Apple Wallet.
          This website stores no data whatsoever and its source code is <a className="text-blue-500 hover:underline" href="https://github.com/jernejstrasner/covidpass" target="_blank" rel="noreferrer">publicly available</a>.
        </p>
